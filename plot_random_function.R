...
##    sample of normalvalues, plot a histogram
...
##    bins    = the number of break points in the hist() function
##              defaults to 10
...
plotRandomNormals <- function(numpts=50, bins=10, 
  ...
  list(Random_Sample = rand_sample, Mean_sample = mean(rand_sample), 
